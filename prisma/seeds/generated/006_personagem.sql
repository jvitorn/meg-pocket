...
COPY "Personagem" ("id", "nome", "apelido", "descricao", "campanhaId", "classeId", "racaId", "elemento", "hp_atual", "mana_atual", "hp_base", "mana_base", "imagem_pixel", "url_imagem", "status_baile", "createdAt", "updatedAt", "baileId", "userId") FROM stdin WITH (FORMAT csv, HEADER true, NULL 'null');
id,nome,apelido,descricao,campanhaId,classeId,racaId,elemento,hp_atual,mana_atual,hp_base,mana_base,imagem_pixel,url_imagem,status_baile,createdAt,updatedAt,baileId,userId
