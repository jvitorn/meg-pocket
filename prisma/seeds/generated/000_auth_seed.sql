-- Generated from personagem.csv userId values
-- Todas as contas usam a senha: seed123
INSERT INTO "User" ("id", "name", "email", "image", "createdAt", "updatedAt")
VALUES
  ('cmknadd9s0000jmsb075f9ziw', 'Seed User 1', 'seed.user.1@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00'),
  ('cmkd5kjbj0000sbk92vwr25fp', 'Seed User 2', 'seed.user.2@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00'),
  ('cmm5pl8ae000004l79z7jtv4d', 'Seed User 3', 'seed.user.3@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00'),
  ('cmm6ed4fr000004l1khlscdo4', 'Seed User 4', 'seed.user.4@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00'),
  ('cmm6j0cs4000004k3l70wa6zg', 'Seed User 5', 'seed.user.5@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00'),
  ('cmm7mwopw000004jr04xkah49', 'Seed User 6', 'seed.user.6@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00'),
  ('cmm99f8gi000004jubjxyz6v3', 'Seed User 7', 'seed.user.7@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00'),
  ('cmm6paz3d000004juybe2lpd4', 'Seed User 8', 'seed.user.8@meg-pocket.local', NULL, TIMESTAMP '2026-03-18 00:00:00', TIMESTAMP '2026-03-18 00:00:00');
